...
export declare function assertRejection(group: string, type: string, settings?: TJS.PartialArgs, compilerOptions?: TJS.CompilerOptions, errType?: RegExp | ErrorConstructor): void;
export {};
